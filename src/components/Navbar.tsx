                ...
                ></span>
                        ...
                        <div className="classNamey-menu">
                            ...
                            <div className="classynav">
                                <ul>
                                    <li className="active"><a href="../pages/index-2.html">Home</a></li>
                                    <li>
                                        <a href="#">Pages</a>
                                        <ul className="dropdown">
                                            <li><a href="../pages/index-2.html">Home</a></li>
                                            <li><a href="../pages/catagories-post.html">Categories</a></li>
                                            <li><a href="../pages/single-post.html">Single Articles</a></li>
                                            ...
                                            <li>
                                                ...
                                                <ul className="dropdown">
                                                    <li><a href="../pages/index-2.html">Home</a></li>
                                                    <li>
                                                        <a href="../pages/catagories-post.html">Categories</a>
                                                    </li>
                                                    <li>
                                                        <a href="../pages/single-post.html">Single Articles</a>
                                                    </li>
                                                    <li><a href="../pages/about.html">About Us</a></li>
                                                    <li><a href="../pages/contact.html">Contact</a></li>
                                                </ul>
                                    ...
                                    <li>
                                        ...
                                        <div className="megamenu">
                                            <ul className="single-mega cn-col-4">
                                                ...
                                                <li><a href="../pages/index-2.html">Home</a></li>
                                                <li><a href="../pages/catagories-post.html">Catagories</a></li>
                                                <li>
                                                    <a href="../pages/single-post.html">Single Articles</a>
                                                </li>
                                                <li><a href="../pages/about.html">About Us</a></li>
